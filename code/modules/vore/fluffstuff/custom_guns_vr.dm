...
/obj/item/weapon/gun/projectile/automatic/patriot
	name = "Patriot"
	desc = "A modded M4A1 with a heavy recoil tube for a stock, and a short barrel. There is a blueish headwrap tied around the barrel."
	icon = 'icons/vore/custom_guns_vr.dmi'
	icon_state = "patriot"
	icon_override = 'icons/vore/custom_guns_vr.dmi'
	item_state = "patriot"
	...
	magazine_type = /obj/item/ammo_magazine/a556b
	allowed_magazines = list(/obj/item/ammo_magazine/a556b, /obj/item/ammo_magazine/a556m, /obj/item/ammo_magazine/a556)
...
/obj/item/weapon/gun/projectile/automatic/mp40
	name = "MP-40"
	desc = "Lock the doors, close the blinds, Wehr going for a ride!"
	icon = 'icons/vore/custom_guns_vr.dmi'
	icon_state = "MP40"
	icon_override = 'icons/vore/custom_guns_vr.dmi'
	item_state = "MP40"
...
obj/item/weapon/gun/projectile/automatic/mac10
	name = "MAC-10"
	desc = "You ready to represent your set now, homie?"
	icon = 'icons/vore/custom_guns_vr.dmi'
	icon_state = "mac10"
	icon_override = 'icons/vore/custom_guns_vr.dmi'
	item_state = "mac10"
...
obj/item/weapon/gun/projectile/automatic/skorpion
	name = "Skorpion"
	desc = "An extremely robust russian submachine gun chambered in 9mm. This one comes straight from a factory in space russia."
	icon = 'icons/vore/custom_guns_vr.dmi'
	icon_state = "skorp"
	icon_override = 'icons/vore/custom_guns_vr.dmi'
	item_state = "skorp"
...
obj/item/weapon/gun/projectile/automatic/sm41
	...
	magazine_type = /obj/item/ammo_magazine/a10mmp
	allowed_magazines = list(/obj/item/ammo_magazine/a10mmp, /obj/item/ammo_magazine/a10mmpr)
	fire_sound = 'sound/weapons/gunshot_smg.ogg'
	load_method = MAGAZINE
	slot_flags = SLOT_BACK

/obj/item/weapon/gun/projectile/automatic/as30
	name = "AS-30"
	desc = "The AS-30 is a durable, rugged looking semi-automatic weapon of a make popular on the frontier worlds This one is the civil variant of the AS-24. Uses 12 gauge shells."
	icon = 'icons/vore/custom_guns_vr.dmi'
	icon_state = "a30"
	icon_override = 'icons/vore/custom_guns_vr.dmi'
	item_state = "a30"
	...
	allowed_magazines = list(/obj/item/ammo_magazine/g12, /obj/item/ammo_magazine/g12/beanbag, /obj/item/ammo_magazine/g12/flash, /obj/item/ammo_magazine/g12/pellet)
...
/obj/item/weapon/gun/projectile/shotgun/pump/rifle/obrez
	name = "Obrez"
	desc = "WHEN YOU SHOW OBREZ TO ENEMY, HE THINKS YOU ARE CRAZED LUNATIC LIKE KRUSCHEV POUNDING SHOE ON DESK AND SHOUTING PLAN TO BURY NATO IN DEEP GRAVE. YOU FIRE WITH FLAME LIKE BURSTING FIRE OF DRAGON, TWISTING BOLT LIKE MANIAC BETWEEN FIRINGS AND EJECTING EMPTY CASE AS BIG AS BEER CAN FROM ACTION ~ Ivan Chesnokov"
	item_state = "obrez"
	icon_state = "obrez"
	fire_sound = 'sound/weapons/deagle.ogg'
	max_shells = 5
	accuracy = -1 //They were used at near-point-blank range, and mostly only used to get a better weapon from killing a soldier.
	w_class = 2 //The obrez was able to be shoved into pockets and shit.
	recoil = 4  //[wrist breaking intensifies]
	caliber = "a762"
...
/obj/item/weapon/gun/projectile/revolver/fluff/serdyrevolver
	name = "Voice Of Reason"
	desc = "It's a classic Colt Police Positive, this one has a dark blued steel frame and a dark oak grip. <span class='warning'>'Emissary Of Broken Bones'</span> is engraved into the barrel. Uses .38 rounds."
	fire_sound = 'sound/weapons/deagle.ogg'
	icon = 'icons/vore/custom_guns_vr.dmi'
	icon_state = "cpp"
	caliber = ".38"
...
// silencedmp5a5 : Ilya Zadovsky
/obj/item/weapon/gun/projectile/colt/fluff/ilyamauser
	name = "Majime"
	desc = "It's a rare, antique, Mauser model 1914. <span class='warning'>'A simple, earnest, reliable person who can get things done without causing drama.'</span> is engraved into the barrel, just below the word 'Majime'. Uses .45 rounds."
