...
/datum/category_item/player_setup_item/occupation/content(mob/user, limit = 16, list/splitJobs = list("Chief Medical Officer")) //If this doesn't work return to 16 [9/25/2016]
	if(!job_master)
		return
